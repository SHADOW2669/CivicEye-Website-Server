...
<head>
    ...
    <link rel="shortcut icon" href="IMAGES/ppg.png" type="image/x-icon"
        onerror="this.href='https://placehold.co/32x32/8300FE/FFFFFF?text=CE'">
...
<body>
    ...
    <?php
    // Start PHP session if needed for login status
    session_start();
    ?>
    ...
    <nav class="navbar">
        <a href="#hero-page" class="navbar-logo">
            <img src="IMAGES/logo1.png"
                onerror="this.onerror=null; this.src='https://placehold.co/150x40/0a0a0a/FFFFFF?text=CivicEye';"
                alt="Civic Eye Logo">
        </a>
    ...
    <main>
        <header id="hero-page" class="hero centered-hero">
            ...
            <a href="#features" class="hero-scroll-down" aria-label="Scroll to Features">
                <i data-lucide="arrow-down-circle"></i> </a>
        </header>

        <section id="features" class="content-section">
            <div class="section-heading" data-aos="fade-up">
                <h2 class="orange-heading">Features & Objectives</h2>
                <p class="subtitle">Discover the core capabilities driving Civic Eye's effectiveness.</p>
            </div>
            <div class="info-grid">
                <div class="info-card purple" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p>Leverages the state-of-the-art YOLOv8 model for high-accuracy identification of traffic
                        violations, starting with helmet usage detection.</p>
                ...
                <div class="info-card orange" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p>Processes live video feeds from various sources (CCTV, webcams, files) to detect and classify
                        violations instantly as they occur.</p>
                    <p class="benefit-caption">⏱️ Instant Violation Alerts</p>
                </div>
                <div class="info-card purple" data-aos="fade-up" data-aos-delay="300">
                    <div class="icon"><i data-lucide="file-check"></i></div>
                    <h4>Automated Evidence Logging</h4>
                    <p>Automatically captures and saves clear visual evidence (images/clips) of violations, complete
                        with timestamps and metadata, stored securely locally or synced to the server.</p>
                ...
                <div class="info-card orange" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h4>Privacy-Focused Local Processing</h4>
                    <p>All AI inference and data processing happen directly on your local machine, ensuring data
                        privacy, security, and minimal latency before optional server sync.</p>
                    <p class="benefit-caption">✅ Secure & Private by Design</p>
                </div>
                <div class="info-card purple" data-aos="fade-up" data-aos-delay="200">
                    <div class="icon"><i data-lucide="database"></i></div>
                    <h4>Centralized Web Dashboard</h4>
                    <p>A secure web interface (civiceye.my) allows authorized personnel to efficiently review, manage,
                        and analyze collected violation data synced from connected devices.</p>
                ...
                <div class="info-card orange" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p>Designed for consistent operation, generating dependable, high-resolution evidence with accurate
                        metadata for every detected violation.</p>
                    <p class="benefit-caption">🛡️ Dependable Monitoring</p>
                </div>
            </div>
        ...
        <section id="detection-workflow" class="content-section">
            <div class="workflow-content-wrapper">
                <div class="workflow-header" data-aos="fade-up" data-aos-delay="100">
                    <h2>Detection & Server Workflow</h2>
                    <p class="subtitle">From camera feed to cloud dashboard: how Civic Eye works online.</p>
                </div>
                <div class="workflow-grid-container">
                     <div class="workflow-visual-panel" data-aos="fade-right" data-aos-delay="200">
                        <img src="https://placehold.co/600x400/1c1c2e/c084fc?text=Workflow+Visual"
                             alt="Workflow Diagram Placeholder"
                             style="max-width: 80%; height: auto; border-radius: 8px; opacity: 0.7;">
                        </div>
                    <div class="workflow-steps-panel" data-aos="fade-left" data-aos-delay="400">
                        <ol class="workflow-steps-list">
                            <li class="step-card" data-aos="fade-up" data-aos-delay="500">
                                <div class="step-number-icon"><span>1</span><i data-lucide="log-in"></i></div>
                                <div class="step-content">
                                    <h4>Login to CivicEye</h4>
                                    <p>Securely authenticate using your registered `civiceye.my` credentials to connect
                                        the local application to your account.</p>
                                </div>
                            </li>
                            <li class="step-card" data-aos="fade-up" data-aos-delay="600">
                                <div class="step-number-icon"><span>2</span><i data-lucide="camera"></i></div>
                                <div class="step-content">
                                    <h4>Connect Video Source</h4>
                                    <p>Select your input: link existing RTSP CCTV streams, activate a PC webcam, or
                                        choose a local video file for analysis.</p>
                                </div>
                            </li>
                            <li class="step-card" data-aos="fade-up" data-aos-delay="700">
                                ...
                                <div class="step-content">
                                    ...
                                    <p>The local application processes the video feed frame-by-frame using the YOLOv8
                                        model to detect violations like 'Without Helmet'.</p>
                                </div>
                            </li>
                            <li class="step-card" data-aos="fade-up" data-aos-delay="800">
                                <div class="step-number-icon"><span>4</span><i data-lucide="upload-cloud"></i></div>
                                <div class="step-content">
                                    <h4>Capture & Sync Evidence</h4>
                                    <p>When a violation is confirmed, the system captures the frame evidence and
                                        metadata, then securely uploads it to your `civiceye.my` cloud account.</p>
                                </div>
                            </li>
                            <li class="step-card" data-aos="fade-up" data-aos-delay="900">
                                <div class="step-number-icon"><span>5</span><i data-lucide="layout-dashboard"></i></div>
                                <div class="step-content">
                                    <h4>Monitor on Web Dashboard</h4>
                                    <p>Log in to the `civiceye.my` website to access the central dashboard, review
                                        synced violation logs, and manage evidence.</p>
                                </div>
                            </li>
                        </ol>
                    </div>
                ...
                <div class="workflow-demo-button-container" data-aos="fade-up" data-aos-delay="1000">
                    <a href="#tech-details" class="hero-btn secondary">
                        <i data-lucide="cpu"></i> <span>View Technical Specs</span>
                    </a>
                </div>
            </div>
        </section>
...
<span class="code-keyword">import</span> <span class="code-variable">time</span> <span class="code-comment"># For timestamp</span>
<span class="code-keyword">import</span> <span class="code-variable">requests</span> <span class="code-comment"># For server communication</span>

<span class="code-comment"># --- Configuration ---</span>
<span class="code-variable">API_ENDPOINT</span> = <span class="code-string">"https://civiceye.my/api/log_violation"</span> <span class="code-comment"># Example endpoint</span>
<span class="code-variable">AUTH_TOKEN</span> = <span class="code-string">"YOUR_API_TOKEN_HERE"</span> <span class="code-comment"># Get this after login</span>
<span class="code-variable">DEVICE_ID</span> = <span class="code-string">"CAM_001"</span> <span class="code-comment"># Example device ID</span>

<span class="code-comment"># Get media input</span>
...
<span class="code-variable">cap</span> = cv2.VideoCapture(<span class="code-number">0</span>) <span class="code-keyword">if</span> <span class="code-keyword">not</span> <span class="code-variable">media_input</span> <span class="code-keyword">else</span> cv2.VideoCapture(<span class="code-variable">media_input</span>)

<span class="code-comment"># Load model and classes</span>
...
<span class="code-comment"># --- Helper Function for Server Upload ---</span>
<span class="code-keyword">def</span> <span class="code-function">upload_violation</span>(<span class="code-variable">image_data</span>, <span class="code-variable">timestamp</span>, <span class="code-variable">frame_num</span>):
    <span class="code-keyword">try</span>:
        <span class="code-variable">files</span> = {<span class="code-string">'evidence_image'</span>: (<span class="code-string">f'{DEVICE_ID}_{timestamp}.jpg'</span>, <span class="code-variable">image_data</span>, <span class="code-string">'image/jpeg'</span>)}
        <span class="code-variable">payload</span> = {
            <span class="code-string">'device_id'</span>: <span class="code-variable">DEVICE_ID</span>,
            <span class="code-string">'timestamp'</span>: <span class="code-variable">timestamp</span>,
            <span class="code-string">'frame_number'</span>: <span class="code-variable">frame_num</span>,
            <span class="code-string">'violation_type'</span>: <span class="code-string">'Without Helmet'</span>
        }
        <span class="code-variable">headers</span> = {<span class="code-string">'Authorization'</span>: <span class="code-string">f'Bearer {AUTH_TOKEN}'</span>}

        <span class="code-variable">response</span> = requests.post(<span class="code-variable">API_ENDPOINT</span>, headers=<span class="code-variable">headers</span>, data=<span class="code-variable">payload</span>, files=<span class="code-variable">files</span>, timeout=<span class="code-number">10</span>)
        <span class="code-keyword">if</span> <span class="code-variable">response</span>.<span class="code-variable">status_code</span> == <span class="code-number">200</span>:
            <span class="code-builtin">print</span>(<span class="code-string">f"Successfully uploaded violation for frame {frame_num}"</span>)
        <span class="code-keyword">else</span>:
            <span class="code-builtin">print</span>(<span class="code-string">f"Failed to upload violation: {response.status_code} - {response.text}"</span>)
    <span class="code-keyword">except</span> <span class="code-variable">requests</span>.<span class="code-variable">exceptions</span>.<span class="code-variable">RequestException</span> <span class="code-keyword">as</span> <span class="code-variable">e</span>:
        <span class="code-builtin">print</span>(<span class="code-string">f"Network error during upload: {e}"</span>)
    <span class="code-keyword">except</span> <span class="code-variable">Exception</span> <span class="code-keyword">as</span> <span class="code-variable">e</span>:
        <span class="code-builtin">print</span>(<span class="code-string">f"An error occurred during upload: {e}"</span>)
...
<span class="code-keyword">while</span> <span class="code-boolean">True</span>:
    ...
    <span class="code-keyword">if</span> <span class="code-keyword">not</span> <span class="code-variable">success</span>: <span class="code-keyword">break</span>
    ...
    <span class="code-variable">violation_detected_in_frame</span> = <span class="code-boolean">False</span>
    ...
    <span class="code-keyword">for</span> <span class="code-variable">r</span> <span class="code-keyword">in</span> <span class="code-variable">results</span>:
        <span class="code-keyword">for</span> <span class="code-variable">box</span> <span class="code-keyword">in</span> <span class="code-variable">r</span>.<span class="code-variable">boxes</span>:
            ...
            <span class="code-variable">box_color</span> = (<span class="code-number">0</span>, <span class="code-number">255</span>, <span class="code-number">0</span>) <span class="code-keyword">if</span> <span class="code-variable">currentClass</span> == <span class="code-string">"With Helmet"</span> <span class="code-keyword">else</span> (<span class="code-number">0</span>, <span class="code-number">0</span>, <span class="code-number">255</span>)

            cvzone.cornerRect(<span class="code-variable">img</span>, (<span class="code-variable">x1</span>, <span class="code-variable">y1</span>, <span class="code-variable">x2</span> - <span class="code-variable">x1</span>, <span class="code-variable">y2</span> - <span class="code-variable">y1</span>), colorR=<span class="code-variable">box_color</span>)
            cvzone.putTextRect(<span class="code-variable">img</span>, <span class="code-string">f'{currentClass} {conf:.2f}'</span>,
                               ...
                               scale=<span class="code-number">1</span>, thickness=<span class="code-number">1</span>, colorR=<span class="code-variable">box_color</span>)

            <span class="code-keyword">if</span> <span class="code-variable">currentClass</span> == <span class="code-string">"Without Helmet"</span>:
                <span class="code-variable">violation_detected_in_frame</span> = <span class="code-boolean">True</span>

    <span class="code-comment"># If violation detected, encode image and send to server</span>
    <span class="code-keyword">if</span> <span class="code-variable">violation_detected_in_frame</span>:
        <span class="code-variable">timestamp_str</span> = time.strftime(<span class="code-string">"%Y-%m-%dT%H:%M:%S"</span>) <span class="code-comment"># ISO format example</span>
        <span class="code-comment"># Encode image to JPEG format in memory</span>
        <span class="code-variable">_</span>, <span class="code-variable">buffer</span> = cv2.imencode(<span class="code-string">'.jpg'</span>, <span class="code-variable">img</span>)
        <span class="code-variable">image_bytes</span> = <span class="code-variable">buffer</span>.tobytes()
        <span class="code-comment"># Call upload function (consider running in a separate thread for non-blocking UI)</span>
        upload_violation(<span class="code-variable">image_bytes</span>, <span class="code-variable">timestamp_str</span>, <span class="code-variable">frame_count</span>)
        <span class="code-comment"># Optional: Add a visual indicator on the frame that upload was attempted</span>
        cvzone.putTextRect(<span class="code-variable">img</span>, <span class="code-string">"Violation Logged"</span>, (<span class="code-number">10</span>, <span class="code-number">30</span>), scale=<span class="code-number">1</span>, thickness=<span class="code-number">1</span>, colorR=(<span class="code-number">0</span>,<span class="code-number">0</span>,<span class="code-number">255</span>))
...
<span class="code-builtin">print</span>(<span class="code-string">"Detection finished."</span>)
                    </code></pre>
                </div>
            </div>
        </section>
            ...
            <div class="cta-content" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="hero-buttons" data-aos="fade-up" data-aos-delay="300">
                    <a href="download.php" class="hero-btn primary">
                        ...
                        <i data-lucide="download" class="lucide-download"></i> </a>
        ...
        <div class="footer-container">
            <div class="footer-top">
                <div class="footer-logo">
                    <img src="IMAGES/logo1.png" alt="Civic Eye Logo"
                        onerror="this.onerror=null; this.src='https://placehold.co/150x40/030305/FFFFFF?text=CivicEye';" />
                </div>
            ...
            <div class="footer-links-section">
                ...
                <div class="footer-links-column">
                    ...
                    <nav>
                        <a href="download.php">Download</a>
                        <a href="#">Documentation</a> <a href="#tech-details">Requirements</a>
                    </nav>
                </div>
                <div class="footer-links-column">
                    <h3>Contact Info</h3>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            if (typeof particlesJS !== 'undefined') {
                particlesJS("particles-js", {
                    "particles": {
                        ...
                        "color": { "value": ["#8300fe", "#38bdf8", "#555"] }, // Array of colors
                        "shape": { "type": "circle" },
                        "opacity": {
                            "value": 0.6, "random": true,
                            "anim": { "enable": true, "speed": 0.6, "opacity_min": 0.15, "sync": false } // Fade animation
                        },
                        "size": {
                        ...
                        "line_linked": {
                            "enable": true, "distance": 130, "color": "#555", // Link color
                            "opacity": 0.5, "width": 1
                        },
                        "move": {
                            "enable": true, "speed": 1.5, "direction": "none", "random": true,
                            "straight": false, "out_mode": "out", "bounce": false, // Move out of canvas
                            "attract": { "enable": true, "rotateX": 600, "rotateY": 1200 } // Attract effect
                        }
                    },
                    "interactivity": {
                        "detect_on": "canvas",
                    ...
                    "retina_detect": true // Adjust for high-density displays
                });
            ...
            if (typeof AOS !== 'undefined') {
                AOS.init({
                    ...
                    offset: 50, // Trigger animation slightly before element is visible
            ...
            function typeText() {
                if (infoElement && charIndex < textToType.length) {
                    ...
                    // Ensure cursor keeps blinking after typing finishes
            ...
            if (infoElement && cursorElement) {
                infoElement.textContent = ''; // Clear initial content
                cursorElement.style.opacity = '1'; // Ensure cursor is visible initially
                setTimeout(typeText, 800); // Delay before starting typing
            }
            ...
            if (copyButton && codeToCopyElement) {
                copyButton.addEventListener('click', () => {
                    ...
                    navigator.clipboard.writeText(codeText).then(() => {
                        ...
                        copyButton.innerHTML = '<i data-lucide="check" style="width: 16px; height: 16px; vertical-align: middle; color: #28c940;"></i>'; // Green check icon
                        if (typeof lucide !== 'undefined') lucide.createIcons(); // Re-render icon
                        // Reset button after 2 seconds
                        setTimeout(() => {
                            copyButton.title = 'Copy Code';
                            copyButton.innerHTML = '<i data-lucide="clipboard" style="width: 16px; height: 16px; vertical-align: middle;"></i>'; // Original clipboard icon
                        ...
                        copyButton.innerHTML = '<i data-lucide="x-circle" style="width: 16px; height: 16px; vertical-align: middle; color: #ff5f57;"></i>'; // Red error icon
                        if (typeof lucide !== 'undefined') lucide.createIcons();
                        // Reset button after 2 seconds
                        setTimeout(() => {
                            copyButton.title = 'Copy Code';
            ...
            if (hamburgerBtn && mobileNav && closeNavBtn) {
                const navLinks = mobileNav.querySelectorAll('a'); // Get all links in the mobile menu
                ...
                // Close menu when a link is clicked (for navigating to sections)
                navLinks.forEach(link => {
                    link.addEventListener('click', () => {
                        setTimeout(closeNav, 100); // Small delay to allow navigation
                    });
                });
                ...
                document.addEventListener('click', (event) => {
                    if (mobileNav.classList.contains('active') &&
                        !mobileNav.contains(event.target) && // Click was outside the menu
                        !hamburgerBtn.contains(event.target)) { // Click was not on the hamburger button
                        closeNav();
                    }
                });
            ...
            if (typeof lucide !== 'undefined') {
                try {
                    lucide.createIcons(); // Render all icons with data-lucide attribute
